...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = `@user Selamat Datang Di @subject\nMohon Untuk Intro Ulang dan Baca Rules Grup di bawah ini ${global.readMore}\n\n@desc`
  conn.bye = 'Selamat Tinggal @user\nKami Harap Kamu Akan Kembali Lagi di @subject'
  ...
  conn.sAnnounceOn = 'Group @subject telah di tutup!\nsekarang hanya admin yang dapat mengirim pesan,untuk para member diharapkan untuk bersabar🤪.'
  conn.sAnnounceOff = 'Group @subject telah di buka!\nsekarang semua peserta dapat mengirim pesan,ciee...member dah bisa ngetik tuh🤪.'
